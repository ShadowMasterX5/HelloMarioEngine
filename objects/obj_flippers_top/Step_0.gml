...
//If Mario comes from below, and the flippers are shut
if collision_rectangle(x,y+15,x+63,y+17,obj_mario,0,0)
and ready < 2
{
...
//If Mario comes from above
else if collision_rectangle(x,y-6,x+63,y+3,obj_mario,0,0)
{
...
else if not collision_rectangle(x,y+16,x+63,y-4,obj_mario,0,0)
and ready = 2
{
