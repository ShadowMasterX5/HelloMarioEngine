...
//If Mario comes from the left, and the flippers are shut
if collision_rectangle(x,y,x-4,y+63,obj_mario,0,0)
and ready < 2
{
...
//If Mario comes from the right
else if collision_rectangle(x+12,y,x+21,y+63,obj_mario,0,0)
{
...
else if not collision_rectangle(x-1,y,x+19,y+63,obj_mario,0,0)
and ready = 2
{
